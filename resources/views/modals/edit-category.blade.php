<div id="modal-edit-category" class="fixed inset-0 z-50 flex items-center justify-center bg-black/50 hidden">
    <div class="w-full max-w-xl rounded-xl bg-white dark:bg-background-dark p-6 shadow-lg">
        <div class="flex items-center justify-between mb-4">
            ...
            <button id="btn-modal-close-category-edit" class="text-slate-400 hover:text-slate-600 dark:hover:text-slate-300">
                ✕
            </button>
        </div>

        <form id="form-edit-category" class="mt-4">
            <input id="input-edit-category-id" type="hidden" />
            <div class="grid grid-cols-1 gap-y-4">
                <div class="flex flex-col gap-1">
                    <label class="text-sm font-medium text-[#0d141b] dark:text-slate-300">Nome*</label>
                    <input id="input-edit-category-name" type="text"
                ...
                <div class="flex flex-col gap-1">
                    ...
                    <textarea id="textarea-edit-category-description" rows="3"
            ...
            <div class="mt-8 flex justify-end gap-3 border-t border-slate-100 dark:border-slate-700 pt-5">
                <button type="button" id="btn-modal-cancel-category-edit"
                ...
                <button id="btn-modal-save-category-edit" type="button"
