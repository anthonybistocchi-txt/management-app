<div id="modal-edit-product" class="fixed inset-0 z-50 flex items-center justify-center bg-black/50 hidden">
    <div class="w-full max-w-2xl rounded-xl bg-white dark:bg-background-dark p-6 shadow-lg">
        <div class="flex items-center justify-between mb-4">
            ...
            <button id="btn-modal-close-product-edit" class="text-slate-400 hover:text-slate-600 dark:hover:text-slate-300">
                ✕
            </button>
        </div>

        <form id="form-edit-product" class="mt-4">
            <input id="input-edit-product-id" type="hidden" />
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                <div class="flex flex-col gap-1 md:col-span-2">
                    <label class="text-sm font-medium text-[#0d141b] dark:text-slate-300">Nome*</label>
                    <input id="input-edit-product-name" type="text"
                ...
                <div class="flex flex-col gap-1">
                    ...
                    <select id="select-edit-product-category"></select>
                </div>

                <div class="flex flex-col gap-1">
                    <label class="text-sm font-medium text-[#0d141b] dark:text-slate-300">Fornecedor*</label>
                    <select id="select-edit-product-provider"></select>
                </div>

                <div class="flex flex-col gap-1">
                    <label class="text-sm font-medium text-[#0d141b] dark:text-slate-300">Preco*</label>
                    <input id="input-edit-product-price" type="text" inputmode="decimal"
                        class="h-11 w-full rounded-lg border border-[#cfdbe7] dark:border-slate-700 bg-[#edf2f7] dark:bg-slate-800 px-3 text-sm text-[#0d141b] dark:text-slate-200" />
                </div>

                <div class="flex flex-col gap-1">
                    <label class="text-sm font-medium text-[#0d141b] dark:text-slate-300">Estoque</label>
                    <input id="input-edit-product-quantity" type="number" min="0"
                        class="h-11 w-full rounded-lg border border-[#cfdbe7] dark:border-slate-700 bg-[#edf2f7] dark:bg-slate-800 px-3 text-sm text-[#0d141b] dark:text-slate-200" />
                </div>

                <div class="flex flex-col gap-1">
                    <label class="text-sm font-medium text-[#0d141b] dark:text-slate-300">Localizacao</label>
                    <select id="select-edit-product-location"></select>
                </div>

                <div class="flex flex-col gap-1 md:col-span-2">
                    <label class="text-sm font-medium text-[#0d141b] dark:text-slate-300">Descricao</label>
                    <textarea id="textarea-edit-product-description" rows="3"
            ...
            <div class="mt-8 flex justify-end gap-3 border-t border-slate-100 dark:border-slate-700 pt-5">
                <button type="button" id="btn-modal-cancel-product-edit"
                ...
                <button id="btn-modal-save-product-edit" type="button"
