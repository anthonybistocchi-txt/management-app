        ...
        <div class="flex flex-col flex-1 overflow-y-auto min-h-0">
            ...
            <main class="flex-1 p-8">
                ...
                <div class="flex flex-wrap items-center justify-between gap-4 mb-6">
                    ...
                    <div class="mt-1 flex items-center gap-2 opacity-80 hover:opacity-100 transition-opacity cursor-default"
                        data-phrase-rotator>
                        <span class="text-xs italic text-text-light-secondary dark:text-text-dark-secondary"
                            data-phrase-quote></span>
                        <span class="text-[10px] font-bold text-primary uppercase tracking-tighter"
                            data-phrase-author></span>
                    </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                    <div
                        ...
                        <div class="flex items-center justify-between gap-3">
                            <p class="text-text-light-secondary dark:text-text-dark-secondary text-sm font-medium">Total
                                de vendas</p>
                            <span id="total_sales_growth"
                                class="inline-flex items-center gap-1 rounded-full bg-green-100 text-green-700 px-2.5 py-1 text-xs font-semibold">
                    ...
                    <div
                        class="flex flex-col gap-2 rounded-xl p-6 bg-white dark:bg-surface-dark border border-border-light dark:border-border-dark">
                        <p class="text-text-light-secondary dark:text-text-dark-secondary text-sm font-medium">Ticket
                            medio</p>
                        <p id="average_ticket"
                            class="text-text-light-primary dark:text-text-dark-primary text-3xl font-bold"></p>
                        <p class="text-text-light-secondary dark:text-text-dark-secondary text-xs">Total dividido pela
                            quantidade de vendas</p>
                    </div>

                    <div
                        class="flex flex-col gap-2 rounded-xl p-6 bg-white dark:bg-surface-dark border border-border-light dark:border-border-dark">
                        <p class="text-text-light-secondary dark:text-text-dark-secondary text-sm font-medium">
                            Quantidade total de pedidos</p>
                        <p id="total_orders"
                            class="text-text-light-primary dark:text-text-dark-primary text-3xl font-bold"></p>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="mb-4">
                        ...
                        <p class="mt-1 text-xs text-text-light-secondary dark:text-text-dark-secondary">Gráfico com as
                            maiores categorias; a tabela abaixo lista todas com rolagem.</p>
                    </div>
                    <div id="sales_category_chart_wrap"
                        class="relative w-full rounded-lg border border-border-light/80 dark:border-border-dark/80 bg-slate-50/50 dark:bg-slate-900/20 p-2">
                        <div class="relative h-[380px] w-full">
                            <canvas id="sales_category_chart"></canvas>
                        </div>
                    </div>
                    <div class="mt-4">
                        <h4 class="text-sm font-semibold text-text-light-primary dark:text-text-dark-primary mb-2">Todas
                            as categorias</h4>
                        <div
                            class="max-h-72 overflow-y-auto rounded-lg border border-border-light dark:border-border-dark">
                            <table class="w-full text-sm">
                                <thead
                                    class="sticky top-0 z-10 bg-slate-100 dark:bg-slate-800/95 border-b border-border-light dark:border-border-dark">
                                ...
                                <tbody id="sales_category_table_body"
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-6">
                    <div
                        ...
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <span class="text-xs text-text-light-secondary dark:text-text-dark-secondary">Por
                                faturamento</span>
                        </div>
                        <div class="overflow-x-auto">
                            <table class="w-full text-sm">
                                ...
                                <tbody id="top_products_table">
                                    <tr>
                                        <td colspan="3"
                                            class="py-4 text-center text-sm text-text-light-secondary dark:text-text-dark-secondary">
                                            Carregando...</td>
                                    </tr>
                                </tbody>
                            </table>
                    ...
                    <div
                        ...
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <span class="text-xs text-text-light-secondary dark:text-text-dark-secondary">Live
                                feed</span>
                        </div>
                        <div id="recent_sales_list" class="flex flex-col gap-3">
                            <div class="text-sm text-text-light-secondary dark:text-text-dark-secondary">Carregando...
                            </div>
                        </div>
                    </div>

                    <div id="low_stock_alert"
                        class="flex flex-col rounded-xl p-6 border border-amber-200 bg-amber-50 text-amber-700">
