                ...
                <main class="p-8">
                    <div class="mx-auto max-w-7xl">
                        <div class="mb-6 flex flex-col gap-1">
                            <h1 class="text-3xl font-bold tracking-tight text-[#0d141b] dark:text-white">Entrada e Saída
                            </h1>
                            <p class="text-base text-[#4c739a] dark:text-slate-400">Relatório de movimentações de entrada
                                e saída de estoque. O conteúdo detalhado será implementado aqui.</p>
                        </div>
                    </div>
                </main>
            </div>
