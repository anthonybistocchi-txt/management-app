...
<body class="font-display">
    <div class="relative flex h-screen min-h-screen w-full flex-col bg-background-light dark:bg-background-dark text-[#0d141b] dark:text-slate-200">
        <div class="flex h-full w-full">
            ...
            <aside id="sidebar-main" class="flex h-full w-64 flex-col justify-between bg-surface-blue text-text-white p-4">
                <div class="flex flex-col gap-8">
                    <div class="flex items-center justify-center px-2">
                        <div class="p-2 rounded-xl w-full shadow-sm flex items-center justify-center">
                            <img id="img-sidebar-logo" src="/images/logo.jpg" alt="Logo Empresa" class="h-12 w-auto object-contain max-w-full">
                        </div>
                    </div>

                    <div class="flex flex-col gap-2">
                        
                        <a id="link-sidebar-dashboard" href="{{ route('dashboard') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-primary/10 hover:text-primary transition-colors">
                            <span class="material-symbols-outlined">dashboard</span>
                            <p class="text-sm font-semibold">Dashboard</p>
                        </a>

                        <a id="link-sidebar-stock-in" href="{{ route('stock') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-primary/10 hover:text-primary transition-colors">
                            <span class="material-symbols-outlined">inventory_2</span>
                            <p class="text-sm font-medium">Registrar entrada</p>
                        </a>

                        <a id="link-sidebar-users" href="{{ route('users') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg bg-primary/10 text-primary transition-colors">
                            <span class="material-symbols-outlined">group</span>
                            <p class="text-sm font-medium">Usuários</p>
                        </a>

                        <a id="link-sidebar-stock-out" href="{{ route('stockOut') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-primary/10 hover:text-primary transition-colors">
                            <span class="material-symbols-outlined">shopping_cart</span>
                            <p class="text-sm font-medium">Registrar venda</p>
                        </a>

                        <a id="link-sidebar-reports" href="#" class="flex items-center gap-3 px-3 py-2.5 opacity-50 cursor-not-allowed">
                            <span class="material-symbols-outlined">summarize</span>
                            <p class="text-sm font-medium">Relatórios</p>
                        </a>

                        <a id="link-sidebar-providers" href="{{ route('providers') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-primary/10 hover:text-primary transition-colors">
                ...
                <div class="flex flex-col gap-1">
                    <a id="link-sidebar-settings" class="flex items-center gap-3 rounded-lg px-3 py-2 text-slate-300 hover:text-white hover:bg-primary/10 transition-colors" href="#">
                        <span class="material-symbols-outlined text-2xl">settings</span>
                        <p class="text-sm font-medium">Configurações</p>
                    </a>
                    <a id="link-sidebar-logout" class="flex items-center gap-3 rounded-lg px-3 py-2 text-slate-300 hover:text-white hover:bg-primary/10 transition-colors" href="#">
            ...
            <div class="flex flex-1 flex-col overflow-y-auto">
                ...
                <header class="flex h-16 items-center justify-end whitespace-nowrap border-b border-solid border-slate-200 dark:border-slate-800 bg-white dark:bg-background-dark px-8">
                ...
                <main class="p-8">
                    <div class="mx-auto max-w-7xl"> 
                        ...
                        <div class="mb-8 flex flex-wrap items-center justify-between gap-4">
                            <div class="flex flex-col gap-1">
                                <h1 class="text-3xl font-bold tracking-tight text-[#0d141b] dark:text-slate-100">Gestão de Usuários</h1>
                                <p class="text-base text-[#4c739a] dark:text-slate-400">Gerencie os usuários do sistema, adicione novos, edite perfis e altere status.</p>
                            </div>
                            
                            <button id="btn-open-create-user" class="flex h-12 items-center justify-center rounded-lg bg-primary text-white px-6 text-sm font-bold gap-2 hover:bg-primary/90 transition-colors">
                                <span class="material-symbols-outlined text-xl">add</span>
                                Adicionar Usuário
                            </button>
                        </div>

                        <div class="mb-6 flex flex-col sm:flex-row gap-4 justify-between items-center rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-background-dark p-4 shadow-sm">
                            <div class="w-full sm:max-w-xs relative">
                                <span class="material-symbols-outlined absolute left-3 top-3 text-[#4c739a]">search</span>
                                <input id="input-search-user" class="form-input h-12 w-full min-w-0 flex-1 resize-none overflow-hidden rounded-lg border border-[#cfdbe7] dark:border-slate-700 bg-background-light dark:bg-slate-800 text-[#0d141b] dark:text-slate-200 placeholder:text-[#4c739a] focus:border-primary focus:outline-0 focus:ring-2 focus:ring-primary/20 pl-10 pr-4 text-base font-normal" 
                        ...
                        <div class="rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-background-dark shadow-sm overflow-hidden">
                                        ...
                                        <tr class="hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-colors">
                                            ...
                                            <td class="px-6 py-4 text-right">
                                                <div class="flex gap-2 justify-end">
                                                    <button class="btn-table-edit text-[#4c739a] hover:text-primary transition-colors" data-id="1"><span class="material-symbols-outlined text-xl">edit</span></button>
                                                    <button class="btn-table-delete text-[#4c739a] hover:text-red-600 transition-colors" data-id="1"><span class="material-symbols-outlined text-xl">delete</span></button>
                                                </div>
                                            </td>
                                        </tr>
                                    </tbody>
                            ...
                            <div class="flex items-center justify-between p-4 border-t border-slate-200 dark:border-slate-800">
                                <span class="text-sm font-normal text-[#4c739a] dark:text-slate-400">Exibindo <span class="font-semibold text-[#0d141b] dark:text-white">1-3</span> de <span class="font-semibold text-[#0d141b] dark:text-white">100</span></span>
                                <div class="flex gap-2">
                                    <button id="btn-pagination-prev" class="flex items-center justify-center px-4 h-10 text-sm font-medium text-[#0d141b] bg-white border border-[#cfdbe7] rounded-lg hover:bg-slate-50 dark:bg-slate-800 dark:border-slate-700 dark:text-slate-300 dark:hover:bg-slate-700 transition-colors">
                                        Anterior
                                    </button>
                                    <button id="btn-pagination-next" class="flex items-center justify-center px-4 h-10 text-sm font-medium text-[#0d141b] bg-white border border-[#cfdbe7] rounded-lg hover:bg-slate-50 dark:bg-slate-800 dark:border-slate-700 dark:text-slate-300 dark:hover:bg-slate-700 transition-colors">
                                        Próximo
                                    </button>
                                </div>
                            </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
        ...
        <div class="flex flex-col gap-1 md:col-span-2"> <label class="text-sm font-medium text-[#0d141b] dark:text-slate-300">
                Nome completo*
            </label>
        ...
        <div class="flex flex-col gap-1">
            ...
            <input id="input-create-cpf" type="text" placeholder="Ex: 123.456.789-00" value="" maxlength="14"
                class="h-11 w-full rounded-lg border border-[#cfdbe7] dark:border-slate-700 bg-background-light dark:bg-slate-800 px-3 text-sm text-[#0d141b] dark:text-slate-200 placeholder:text-slate-400 focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20 transition-all" />
        </div>
