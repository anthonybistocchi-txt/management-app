<!DOCTYPE html>
<html lang="pt-BR">
@vite(['resources/ts/pages/admin/reports/stock-card.ts'])
                    ...
                    <div class="mx-auto max-w-7xl">
                        ...
                        <div class="mb-6 flex flex-wrap items-start justify-between gap-4">
                            <div class="flex flex-col gap-1">
                                ...
                                <p class="text-base text-[#4c739a] dark:text-slate-400">Histórico de movimentações por produto com saldo antes e após cada operação.</p>
                            </div>
                            ...
                            <details class="relative">
                                ...
                                <div
                                    ...
                                    <a id="btn-download-stock-card-csv" href="#" class="block px-3 py-2 text-slate-600 hover:bg-slate-50 cursor-pointer">CSV</a>
                                    <a id="btn-download-stock-card-pdf" href="#" class="block px-3 py-2 text-slate-600 hover:bg-slate-50 cursor-pointer">PDF</a>
                                </div>
                            </details>
                        </div>
                        ...
                        <div class="mb-6 rounded-xl bg-white dark:bg-background-dark p-4 shadow-sm">
                            <div class="flex flex-col lg:flex-row gap-3 items-end w-full">
                                ...
                                <div class="relative w-full lg:w-auto lg:flex-[1.5] flex-shrink-0">
                                    ...
                                    <select id="filter-stock-card-product"></select>
                                </div>
                                ...
                                <div class="relative w-full lg:w-auto lg:flex-[1.5] flex-shrink-0">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input id="filter-stock-card-date-range" type="text"
                                ...
                                <div class="relative w-full lg:w-auto lg:flex-1 flex-shrink-0">
                                    ...
                                    <select id="filter-stock-card-location">
                                ...
                                <div class="w-full lg:w-auto lg:flex-none">
                                    <button type="button" id="btn-search-stock-card"
                        ...
                        <div class="rounded-xl bg-white dark:bg-background-dark shadow-sm overflow-hidden">
                            <div class="overflow-x-auto">
                                <table id="table-stock-card" class="w-full text-sm text-left text-[#4c739a] dark:text-slate-400"></table>
                            </div>
                        </div>
