                    ...
                    <div class="flex items-center gap-4">
                        <div class="flex items-center gap-3">
                            ...
                            <div class="flex flex-col text-sm">
                                <h1 id="text-header-username" class="font-medium text-[#0d141b] dark:text-slate-200">Nome do Usuário</h1>
                                <p id="text-header-role" class="text-[#4c739a] dark:text-slate-400">Administrador</p>
                            </div>
                        </div>
                    </div>
                </header>
