<!DOCTYPE html>
<html lang="pt-BR">
@vite(['resources/ts/pages/index/management-categories.ts'])
@vite(['resources/ts/app.ts', 'resources/css/app.css'])

<head>
    <meta charset="utf-8" />
    <meta content="width=device-width, initial-scale=1.0" name="viewport" />
    <title>Categorias - Gestao de Estoque</title>
...
<body class="font-display">
    <div class="relative flex h-screen min-h-screen w-full flex-col bg-background-light dark:bg-background-dark text-[#0d141b] dark:text-slate-200">
        <div class="flex h-full w-full">
            ...
            @include('partials.sidebar-main', ['active' => 'categories'])
            ...
            <div class="flex flex-1 flex-col overflow-y-auto">
                ...
                <main class="flex-1 p-8">
                    <div class="mx-auto max-w-7xl">
                        @include('partials.table-categories')
                    </div>
                </main>
