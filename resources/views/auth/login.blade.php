...
@vite(['resources/ts/pages/login.ts'])
            ...
            <div class="flex flex-1">
                <div
                    ...
                    <div class="relative z-10 flex flex-col items-center gap-6">
                        ...
                        <h1 class="text-5xl font-black text-white leading-tight tracking-tighter">Centralize tarefas. Simplifique processos. Aumente resultados.</h1>
                    ...
                    <div class="layout-content-container flex flex-col max-w-md w-full flex-1 justify-center">
                        <div class="flex flex-col gap-3 mb-8">
                            ...
                            <p
                                ...
                                Bem-vindo de volta! Por favor, insira seus dados.</p>
                        </div>
                            ...
                            <label class="flex flex-col w-full">
                                ...
                                <div
                                    ...
                                    <input
                                        ...
                                        placeholder="Digite seu usuário ou e-mail" value="" />
                                </div>
                            </label>
                            <label class="flex flex-col w-full">
                                <p class="text-text-light dark:text-text-dark text-sm font-medium leading-normal pb-2">
                                ...
                                <div
                                    ...
                                    <input
                                        ...
                                        placeholder="Digite sua senha" type="password" value="" />
                                    <button
                                        class="text-text-secondary-light dark:text-text-secondary-dark flex bg-background-light dark:bg-gray-800 items-center justify-center px-4 rounded-r-lg cursor-pointer">
                        ...
                        <div class="flex justify-end pt-3">
                            <a class="text-primary dark:text-secondary hover:underline text-sm font-medium leading-normal"
                        ...
                        <div class="flex items-center justify-center">
                            <p class="text-text-secondary-light dark:text-text-secondary-dark text-sm font-normal">Não
                                tem uma conta? <a class="font-semibold text-primary dark:text-secondary hover:underline"
                                    href="#">Crie aqui</a></p>
                        </div>
                    </div>
                </div>
