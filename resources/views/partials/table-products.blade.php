<div class="mb-8 flex flex-wrap items-center justify-between gap-4">
    <div class="flex flex-col gap-1">
        <h1 class="text-3xl font-bold tracking-tight text-[#0d141b]">Gestao de produtos</h1>
        <p class="text-base text-[#4c739a] dark:text-slate-400">Gerencie os produtos cadastrados.</p>
    </div>

    <button id="btn-open-create-product"
...
<div class="mb-6 flex flex-col sm:flex-row gap-4 justify-between items-center rounded-xl bg-white dark:bg-background-dark p-4 shadow-sm">
    ...
    <div class="flex gap-2 w-full sm:w-auto">
        <div class="relative w-full sm:w-48">
            <select id="select-filter-product-category">
                <option value="all">Categorias</option>
                <option value="all">Todas</option>
            </select>
        </div>
        <div class="relative w-full sm:w-48">
            <select id="select-filter-product-provider">
                <option value="all">Fornecedores</option>
                <option value="all">Todos</option>
            </select>
        </div>
        <div class="relative w-full sm:w-48">
            <select id="select-filter-product-location">
                <option value="all">Locais</option>
                <option value="all">Todos</option>
            </select>
        </div>
    </div>
    <button id="btn-submit-search-product"
        class="flex h-10 items-center justify-center rounded-lg bg-primary text-white px-6 text-sm font-bold gap-2 hover:bg-primary/90 transition-colors">
